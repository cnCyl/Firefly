...
export const zh_CN: Translation = {
	...
	[Key.qidian]: "起点书架",
	[Key.qidianDescription]: "我的起点中文网书架，按分组整理",
	[Key.qidianSearch]: "搜索书籍...",
	[Key.qidianNoResults]: "没有找到匹配的书籍",
	[Key.qidianNoData]: "书架暂无数据",
	[Key.qidianNoDataHint]: "请运行 pnpm fetch-qidian 抓取书架数据",
	[Key.qidianReadProgress]: "阅读进度",
	[Key.qidianFetchedAt]: "抓取时间",
	[Key.qidianFetchHint]: "运行 pnpm fetch-qidian 可更新书架数据",
	[Key.qidianRecommend]: "推荐",
	[Key.qidianRecommended]: "已推荐",
	[Key.qidianReadToLatest]: "已读至最新",
	[Key.qidianNotReadToLatest]: "未读至最新",
	[Key.qidianColRecommend]: "推荐",
	[Key.qidianColStatus]: "状态",
	[Key.qidianColCategory]: "类型",
	[Key.qidianColTitle]: "书名",
