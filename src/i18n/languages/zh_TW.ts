...
export const zh_TW: Translation = {
	...
	[Key.qidian]: "起點書架",
	[Key.qidianDescription]: "我的起點中文網書架，按分組整理",
	[Key.qidianSearch]: "搜索書籍...",
	[Key.qidianNoResults]: "沒有找到匹配的書籍",
	[Key.qidianNoData]: "書架暫無數據",
	[Key.qidianNoDataHint]: "請運行 pnpm fetch-qidian 抓取書架數據",
	[Key.qidianReadProgress]: "閱讀進度",
	[Key.qidianFetchedAt]: "抓取時間",
	[Key.qidianFetchHint]: "運行 pnpm fetch-qidian 可更新書架數據",
	[Key.qidianRecommend]: "推薦",
	[Key.qidianRecommended]: "已推薦",
	[Key.qidianReadToLatest]: "已讀至最新",
	[Key.qidianNotReadToLatest]: "未讀至最新",
	[Key.qidianColRecommend]: "推薦",
	[Key.qidianColStatus]: "狀態",
	[Key.qidianColCategory]: "類型",
	[Key.qidianColTitle]: "書名",
