...
export const en: Translation = {
	...
	[Key.qidian]: "Qidian Bookshelf",
	[Key.qidianDescription]: "My Qidian bookshelf, organized by groups",
	[Key.qidianSearch]: "Search books...",
	[Key.qidianNoResults]: "No matching books found",
	[Key.qidianNoData]: "Bookshelf is empty",
	[Key.qidianNoDataHint]: "Run pnpm fetch-qidian to fetch bookshelf data",
	[Key.qidianReadProgress]: "Reading progress",
	[Key.qidianFetchedAt]: "Fetched at",
	[Key.qidianFetchHint]: "Run pnpm fetch-qidian to update bookshelf data",
	[Key.qidianRecommend]: "Recommend",
	[Key.qidianRecommended]: "Recommended",
	[Key.qidianReadToLatest]: "Read to latest",
	[Key.qidianNotReadToLatest]: "Not read to latest",
	[Key.qidianColRecommend]: "Rec",
	[Key.qidianColStatus]: "Status",
	[Key.qidianColCategory]: "Category",
	[Key.qidianColTitle]: "Title",
